...
coordenadas = [] # Se hace una lista vacía, a la cual se la agregarán las coordenadas correspondientes.
...
if x > 0: # Condición: Si x es mayor a cero, es decir, si es positiva, entonces se añade a la lista 'coordendas'.
    ...
    print ('ERROR: No se puede ingresar el valor de cero [0]. Por favor ingrese otro valor.')   
